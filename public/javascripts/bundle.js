...
/***/ function(module, exports, __webpack_require__) {
	...
	function main() {
	  ...
	  _reactDom2['default'].render(_react2['default'].createElement(_componentsAppJsx2['default'], null), app);
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _MainViewJsx = __webpack_require__(165);

	var _MainViewJsx2 = _interopRequireDefault(_MainViewJsx);

	exports['default'] = function () {
	    return _react2['default'].createElement(_MainViewJsx2['default'], null);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var MainView = _react2['default'].createClass({
	    ...
	    handleSubmit: function handleSubmit(e) {
	        ...
	        var url = 'http://localhost:3000/search/' + this.state.name;

	        _superagent2['default'].get(url).end(this.setId);
	    },
	    setId: function setId(err, res) {
	        console.log('called');
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(
	                'p',
	                null,
	                'Please enter your summoner name below'
	            ),
	            _react2['default'].createElement(
	                'form',
	                { onSubmit: this.handleSubmit },
	                _react2['default'].createElement('input', { onChange: this.onChange, value: this.state.name }),
